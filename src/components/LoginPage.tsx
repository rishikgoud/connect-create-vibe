        ...
        <div className="feature-card slide-up">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a href="#forgot" className="text-primary hover:text-primary/80 transition-smooth">
          ...
          <div className="mt-6 text-center">
            <p className="text-muted-foreground">
              ...
              <a href="#register" className="text-primary hover:text-primary/80 font-medium transition-smooth">
                Sign up
              </a>
            </p>
          </div>
